...
export default {
  ...
  alias: [],
  category: 'EPHOTO',
  description: '1917 movie style text',
  usage: '.1917style <text>',
  permission: 1,
  cooldown: 10,
