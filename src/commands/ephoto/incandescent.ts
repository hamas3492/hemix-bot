...
export default {
  ...
  alias: [],
  category: 'EPHOTO',
  description: 'Incandescent text',
  usage: '.incandescent <text>',
  permission: 1,
  cooldown: 10,
